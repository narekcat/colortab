========================================================================
		ActiveX Control DLL : COLORTAB
========================================================================

ControlWizard has created this project for your COLORTAB ActiveX Control
...
that make up your COLORTAB ActiveX Control DLL.
...
ColortabCtl.h
	This file contains the declaration of the CColortabCtrl C++ class.

ColortabCtl.cpp
	This file contains the implementation of the CColortabCtrl C++ class.

ColortabPpg.h
	This file contains the declaration of the CColortabPropPage C++ class.

ColortabPpg.cpp
	This file contains the implementation of the CColortabPropPage C++ class.

ColortabCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CColortabCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file colortab.rc.
